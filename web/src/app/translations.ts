...
export const translations: Record<"th" | "en", Translation> = {
  th: {
    ...
    specDescText1: "หน้าต่างและกระจกโครงสร้างประสิทธิภาพสูงของ Window Asia ได้รับการออกแบบทางวิศวกรรมให้มีความทนทานต่อสภาพอากาศสูงและป้องกันรังสี UV ได้ดีเยี่ยม โครงเกียร์แมกนีเซียมและอลูมิเนียมเกรดพรีเมียมช่วยเพิ่มความทนทานแต่นั่วหนักเบา",
  ...
  en: {
    ...
    specDescText1: "Window Asia's high-performance windows and structural glass panels are engineered for superior weather resilience and exceptional UV protection. The premium magnesium-aluminum alloy frame offers enhanced durability while keeping the unit lightweight.",
